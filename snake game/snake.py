...
# Background Image
welcomeimg = pygame.image.load("wgame.jpg")
bgimg = pygame.image.load("snake.jpg")
exitimg = pygame.image.load("gameover.jpg")
...
def welcom() :
    ...
    while not exit_game:
        ...
        text_screen("Welcome to Snakes", orange, 400, 200)
        text_screen("Press Space Bar To Play", orange, 370, 300)
